...
export function SettingsClient({
  ...
  const [panel, setPanel] = useState<"password" | "recovery" | null>(null);
  ...
  useEffect(() => {
    function sync() {
      ...
      if (hash === "password" || hash === "recovery") setPanel(hash);
      else setPanel(null);
    }
    sync();
  ...
  return (
    <div className="mt-12 space-y-10 border-t border-[var(--rule)] pt-8">
      {panel === "password" ? (
