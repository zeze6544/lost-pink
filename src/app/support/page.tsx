...
export default function SupportPage() {
  return (
    <DocPage title="support">
      <DocSection title="how do i reach you?">
        <p>
      ...
      <DocSection title="how do i sign in?">
        <p>
      ...
      <DocSection title="mail app setup">
        <p>
      ...
      <DocSection title="mail not arriving / sending">
        <p>
      ...
      <DocSection title="billing, refunds, renewals">
        <p>
      ...
      <DocSection title="when payment ends">
        <p>
      ...
      <DocSection title="abuse / contact">
        <p>
