    ...
    <DocPage title="privacy">
      ...
      <DocQuestion q="what is public vs private?">
        <p>
          ...
          polar ids, and mailbox secrets stay private. we do not publish
      ...
      <DocQuestion q="who handles cards?">
        <p>
          payment details are handled by polar. write{" "}
          <a href="mailto:privacy@lost.pink">privacy@lost.pink</a> or{" "}
